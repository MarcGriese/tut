...
const ChartEnergyConsumptionGeneral = () => {
    const [chartData, setChartData] = useState({})

    useEffect(() => {
        const fetchData = async () => {
            const result = await fetch('http://localhost:8080/api/energyconsumption/general')
...
export default ChartEnergyConsumptionGeneral