...
import Chart from '../../Charts/Energy Consumption/ChartEnergyConsumptionGeneral.js'


function EnergyConsumptionGeneral() {
            ...
            <div className="settings screen">
                <div className="overlap-group2">
                    ...
                    <div className="page-title aileron-bold-white-25px">
                        <span className="aileron-bold-white-25px">TOTAL ENERGY CONSUMPTION</span>
                    </div>
                    <DaySelection />
                </div>
            </div>
...
export default EnergyConsumptionGeneral;