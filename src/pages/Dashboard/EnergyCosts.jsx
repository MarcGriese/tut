...
import Chart from '../../Charts/Energy Costs/ChartEnergyCostsGeneral'


function EnergyCostsGeneral() {
            ...
            <div className="settings screen">
                <div className="overlap-group2">
                    ...
                    <div className="page-title aileron-bold-white-25px">
                        <span className="aileron-bold-white-25px">TOTAL ENERGY COSTS</span>
                    </div>
                    <DaySelection />
                </div>
            </div>
...
export default EnergyCostsGeneral;