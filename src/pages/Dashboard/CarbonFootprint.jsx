...
import Chart from '../../Charts/Carbon Footprint/ChartCarbonFootprintGeneral.js'


function CarbonFootprintGeneral() {
            ...
            <div className="settings screen">
                <div className="overlap-group2">
                    ...
                    <div className="page-title aileron-bold-white-25px">
                        <span className="aileron-bold-white-25px">TOTAL CO2 EMISSIONS</span>
                    </div>
                    <DaySelection />
                </div>
            </div>
...
export default CarbonFootprintGeneral;